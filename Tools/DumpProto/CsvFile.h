...
class cCsvAlias
{
    private:
        #if _MSC_VER
        typedef std::unordered_map<std::string, size_t> NAME2INDEX_MAP; // @fix6
        typedef std::unordered_map<size_t, std::string> INDEX2NAME_MAP; // @fix6
        #else
    ...
    private:
        ...
        /// \brief 대입 연산자 금지
        const cCsvAlias& operator = (const cCsvAlias&)
        {
            return *this;
        }
};
...
class cCsvRow : public std::vector<std::string>
{
    ...
    private:
        ...
        /// \brief 대입 연산자 금지
        const cCsvRow& operator = (const cCsvRow&)
        {
            return *this;
        }
};
...
class cCsvFile
{
    ...
    private:
        ...
        /// \brief 대입 연산자 금지
        const cCsvFile& operator = (const cCsvFile&)
        {
            return *this;
        }
};
...
class cCsvTable
{
    ...
    private:
        ...
        /// \brief 대입 연산자 금지
        const cCsvTable& operator = (const cCsvTable&)
        {
            return *this;
        }
};
