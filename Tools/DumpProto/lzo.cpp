...
bool CLZObject::Compress()
{
    ...
    * (DWORD*) pbBuffer = ms_dwFourCC;
    ...
    if (int r = lzo1x_1_compress ((BYTE*) m_pbIn, m_pHeader->dwRealSize, pbBuffer, (lzo_uint*)&iOutLen, CLZO::instance().GetWorkMemory()); LZO_E_OK != r)
    {
...
BYTE* CLZObject::Decrypt (DWORD * pdwKey)
{
    ...
    auto * pbDecryptBuffer = new BYTE[m_pHeader->dwEncryptSize];
