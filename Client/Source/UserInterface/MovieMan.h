...
class CMovieMan : public CSingleton<CMovieMan>
{
    ...
    private:
        ...
        HRESULT             RenderStreamToSurface(IDirectDrawSurface *pSurface, IDirectDrawMediaStream *pDDStream, IMultiMediaStream *pMMStream, bool bSkipAllowed, int nPostEffectID,
