...
{
    if (TPacketGCPing kPacketPing; !Recv (sizeof (kPacketPing), &kPacketPing))
    {
        return false;
    }
...
{
    if (TPacketGCNEWCIBNPasspodRequest kRequestPacket; !Recv (sizeof (kRequestPacket), &kRequestPacket))
    {
        return false;
    }
...
{
    if (TPacketKeyAgreementCompleted packet; !Recv (sizeof (packet), &packet))
    {
        return false;
    }
