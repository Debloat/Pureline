...
bool PackInitialize(const char* c_pszFolder)
{
    ...
    if (const std::string& strPackType = TextLoader.GetLineString(0); strPackType.compare("FILE") && strPackType.compare("PACK"))
    {
    ...
    std::string strTexCachePackName;
...
int APIENTRY WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
    ...
    {
        MessageBox(NULL, ApplicationStringTable_GetStringz(IDS_ERR_MUST_LAUNCH_FROM_PATCHER, "ERR_MUST_LAUNCH_FROM_PATCHER"), ApplicationStringTable_GetStringz(IDS_APP_NAME,
                   "APP_NAME"), MB_ICONSTOP);
        goto Clean;
    }
    #endif
