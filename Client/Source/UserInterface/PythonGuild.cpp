...
{
    if (TGuildMemberData * pGuildMemberData; GetMemberDataPtrByPID(rGuildMemberData.dwPID, &pGuildMemberData))
    {
...
{
    m_GuildNameMap.try_emplace(dwID, c_szName);
}
...
PyObject* guildGetGuildExperience(PyObject * poSelf, PyObject * poArgs)
{
    ...
    if (int GULID_MAX_LEVEL = 20; rGuildInfo.dwGuildLevel >= GULID_MAX_LEVEL)
    {
