...
class CPythonNetworkStream : public CNetworkStream, public CSingleton<CPythonNetworkStream>
{
    ...
    protected:
        ...
        void __RefreshAlignmentWindow() const;
        ...
        void __RefreshTargetBoardByVID(DWORD dwVID) const;
        void __RefreshTargetBoardByName(const char* c_szName) const;
        void __RefreshTargetBoard() const;
