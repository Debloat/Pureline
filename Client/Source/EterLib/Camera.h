...
using eCameraState = enum _eCameraState_
{
    CAMERA_STATE_NORMAL,
...
class CCamera
{
    ...
    public:
        ...
        unsigned long& GetNumScreenBuilding()
        {
        ...
        const D3DXVECTOR3& GetView() const
        {
            return m_v3View;
        }
        const D3DXVECTOR3& GetCross() const
        {
            return m_v3Cross;
        }
        ...
        const D3DXMATRIX& GetInverseViewMatrix() const
        {
...
using TCameraMap = std::map<BYTE, CCamera*>;
