...
class D3D_CDeviceInfo
{
    public:
        ...
        BOOL Find (UINT uScrWidth, UINT uScrHeight, BOOL isWindowed, UINT* piD3DModeInfo);
...
class D3D_CAdapterInfo
{
    public:
        D3D_CAdapterInfo() {}
        ~D3D_CAdapterInfo() {}
        BOOL Find (UINT uScrWidth, UINT uScrHeight, BOOL isWindowed, UINT* piD3DModeInfo, UINT* piD3DDevInfo);
...
class D3D_CDisplayModeAutoDetector
{
    public:
        ...
        BOOL Find (UINT uScrWidth, UINT uScrHeight, BOOL isWindowed, UINT* piD3DModeInfo, UINT* piD3DDevInfo, UINT* piD3DAdapterInfo);
