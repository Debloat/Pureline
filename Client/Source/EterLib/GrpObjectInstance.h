...
class CGraphicObjectInstance : public CGraphicCollisionObject
{
    ...
    public:
        ...
        D3DXVECTOR3&            GetTBBoxMin()
        {
            return m_v3TBBoxMin;
        }
        D3DXVECTOR3&            GetTBBoxMax()
        {
            return m_v3TBBoxMax;
        }
        D3DXVECTOR3&            GetBBoxMin()
        {
            return m_v3BBoxMin;
        }
        D3DXVECTOR3&            GetBBoxMax()
        {
            return m_v3BBoxMax;
        }
    ...
    protected:
        ...
        D3DXVECTOR3             m_v3TBBoxMin;
        D3DXVECTOR3 m_v3TBBoxMax;
        D3DXVECTOR3             m_v3BBoxMin;
        D3DXVECTOR3 m_v3BBoxMax;
