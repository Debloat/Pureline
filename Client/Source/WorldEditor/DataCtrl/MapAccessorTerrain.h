...
class CTerrainAccessor : public CTerrain
{
    ...
    public:
        ...
        bool SaveShadowFromD3DTexture8 (const std::string & c_rstrMapName, LPDIRECT3DTEXTURE9 lpShadowTexture);
        bool SaveMiniMapFromD3DTexture8 (const std::string & c_rstrMapName, LPDIRECT3DTEXTURE9 lpShadowTexture);
