...
class CFlyingInstance
{
    ...
    public:
        ...
        void SetEventHandler(IFlyEventHandler * pHandler)
        {
            m_pHandler = pHandler;
        }
        ...
        void SetPierceCount(int iCount)
        {
            m_iPierceCount = iCount;
        }
        void SetOwner(IActorInstance * pOwner)
        {
            m_pOwner = pOwner;
        }
        void SetSkillIndex(DWORD dwIndex)
        {
