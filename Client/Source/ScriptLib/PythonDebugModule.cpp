...
static PyObject* dbgLogBox(PyObject* poSelf, PyObject* poArgs)
{
    char* szMsg;
    char* szCaption;
...
static PyObject* dbgTrace(PyObject* poSelf, PyObject* poArgs)
{
    char* szMsg;
    if (!PyTuple_GetString(poArgs, 0, &szMsg))
    {
...
static PyObject* dbgTracen(PyObject* poSelf, PyObject* poArgs)
{
    char* szMsg;
    if (!PyTuple_GetString(poArgs, 0, &szMsg))
    {
...
static PyObject* dbgTraceError(PyObject* poSelf, PyObject* poArgs)
{
    char* szMsg;
    if (!PyTuple_GetString(poArgs, 0, &szMsg))
    {
...
static PyObject* dbgRegisterExceptionString(PyObject* poSelf, PyObject* poArgs)
{
    char* szMsg;
    if (!PyTuple_GetString(poArgs, 0, &szMsg))
    {
