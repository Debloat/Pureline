...
namespace UI
{
    ...
    class CSlotWindow : public CWindow
    {
        ...
        public:
            ...
            void SetCoverButton(DWORD dwIndex, const char* c_szUpImageName, const char* c_szOverImageName, const char* c_szDownImageName, const char* c_szDisableImageName,
