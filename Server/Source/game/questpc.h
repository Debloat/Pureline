...
namespace quest
{
    ...
    class PC
    {
        ...
        public:
            ...
            bool        HasReward()
            {
                return !m_vRewardData.empty() || m_bIsGivenReward;
            }
            ...
            void        SetSendDoneFlag()
            {
                m_bShouldSendDone = true;
            }
            ...
            void        SetConfirmWait (DWORD dwPID)
            {
                m_bConfirmWait = true;
                m_dwWaitConfirmFromPID = dwPID;
            }
            void        ClearConfirmWait()
            {
                m_bConfirmWait = false;
            }
            bool        IsConfirmWait() const
            {
                return m_bConfirmWait;
            }
            bool        IsConfirmWait (DWORD dwPID) const
            {
                return m_bConfirmWait && dwPID == m_dwWaitConfirmFromPID;
            }
