...
namespace quest
{
    ...
    // "pc" Lua functions
    //
    static int pc_has_master_skill(lua_State* L)
    {
    ...
    static int pc_remove_skill_book_no_delay(lua_State* L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
    ...
    static int pc_is_skill_book_no_delay(lua_State* L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
    ...
    static int pc_learn_grand_master_skill(lua_State* L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
    ...
    static int pc_set_warp_location(lua_State * L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
    ...
    static int pc_set_warp_location_local(lua_State * L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
        ...
        auto lMapIndex = (long) lua_tonumber(L, 1);
        ...
        auto x = (int) lua_tonumber(L, 2);
        auto y = (int) lua_tonumber(L, 3);
    ...
    static int pc_get_start_location(lua_State * L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
    ...
    static int pc_warp(lua_State * L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
    ...
    static int pc_warp_local(lua_State * L)
    {
        if (!lua_isnumber(L, 1))
        {
    ...
    static int pc_warp_exit(lua_State * L)
    {
        CQuestManager::instance().GetCurrentCharacterPtr()->ExitToSavedLocation();
        return 0;
    }

    static int pc_in_dungeon(lua_State * L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
    ...
    static int pc_hasguild(lua_State * L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
    ...
    static int pc_getguild(lua_State * L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
    ...
    static int pc_isguildmaster(lua_State * L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();

        if (CGuild * g = ch->GetGuild())
        {
    ...
    static int pc_destroy_guild(lua_State * L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
    ...
    static int pc_remove_from_guild(lua_State* L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
        CGuild * g = ch->GetGuild();
    ...
    static int pc_give_gold(lua_State* L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
        ...
        auto iAmount = (int) lua_tonumber(L, 1);
    ...
    static int pc_warp_to_guild_war_observer_position(lua_State* L)
    {
        luaL_checknumber(L, 1);
        luaL_checknumber(L, 2);

        auto gid1 = (DWORD)lua_tonumber(L, 1);
        auto gid2 = (DWORD)lua_tonumber(L, 2);

        CGuild* g1 = CGuildManager::instance().FindGuild(gid1);

        if (CGuild* g2 = CGuildManager::instance().FindGuild(gid2); !g1 || !g2)
        {
    ...
    static int pc_give_item_from_special_item_group(lua_State* L)
    {
        luaL_checknumber(L, 1);

        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();

        auto dwGroupVnum = (DWORD) lua_tonumber(L, 1);
    ...
    static int pc_enough_inventory(lua_State* L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
        if (!lua_isnumber(L, 1))
        {
        ...
        auto item_vnum = (DWORD)lua_tonumber(L, 1);
    ...
    static int pc_give_item(lua_State* L)
    {
    ...
    static int pc_give_or_drop_item(lua_State* L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
    ...
    static int pc_give_or_drop_item_and_select(lua_State* L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
    ...
    static int pc_get_current_map_index(lua_State* L)
    {
        lua_pushnumber(L, CQuestManager::instance().GetCurrentCharacterPtr()->GetMapIndex());
        return 1;
    }

    static int pc_get_x(lua_State* L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
    ...
    static int pc_get_y(lua_State* L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
    ...
    static int pc_get_local_x(lua_State* L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();

        if (LPSECTREE_MAP pMap = SECTREE_MANAGER::instance().GetMap(ch->GetMapIndex()))
        {
    ...
    static int pc_get_local_y(lua_State* L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
    ...
    static int pc_count_item(lua_State* L)
    {
        if (lua_isnumber(L, -1))
        {
    ...
    static int pc_remove_item(lua_State* L)
    {
        if (lua_gettop(L) == 1)
        {
            DWORD item_vnum;
            ...
            sys_log(0, "QUEST remove a item vnum %d of %s[%d]", item_vnum, CQuestManager::instance().GetCurrentCharacterPtr()->GetName(),
        ...
        else if (lua_gettop(L) == 2)
        {
            ...
            auto item_count = (DWORD) lua_tonumber(L, 2);
    ...
    static int pc_change_sp(lua_State * L)
    {
        ...
        auto val = (long) lua_tonumber(L, 1);
    ...
    static int pc_get_weapon(lua_State * L)
    {
    ...
    static int pc_get_armor(lua_State * L)
    {
    ...
    static int pc_get_wear(lua_State * L)
    {
        if (!lua_isnumber(L, 1))
        {
    ...
    static int pc_get_money(lua_State * L)
    {
    ...
    static int pc_change_money(lua_State * L)
    {
        int gold = (int)lua_tonumber(L, -1);

        if (LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr(); gold + ch->GetGold() < 0)
        {
    ...
    static int pc_set_another_quest_flag(lua_State* L)
    {
    ...
    static int pc_get_another_quest_flag(lua_State* L)
    {
    ...
    static int pc_get_flag(lua_State* L)
    {
        if (!lua_isstring(L, -1))
        {
            sys_err("QUEST wrong get flag");
    ...
    static int pc_get_quest_flag(lua_State* L)
    {
        if (!lua_isstring(L, -1))
        {
            sys_err("QUEST wrong get flag");
    ...
    static int pc_set_flag(lua_State* L)
    {
    ...
    static int pc_set_quest_flag(lua_State* L)
    {
        if (!lua_isstring(L, 1) || !lua_isnumber(L, 2))
        {
            sys_err("QUEST wrong set flag");
    ...
    static int pc_del_quest_flag(lua_State *L)
    {
        if (!lua_isstring(L, 1))
        {
    ...
    static int pc_give_exp2(lua_State* L)
    {
        CQuestManager& q = CQuestManager::instance();
    ...
    static int pc_give_exp(lua_State* L)
    {
        if (!lua_isstring(L, 1) || !lua_isnumber(L, 2))
        {
            return 0;
    ...
    static int pc_give_exp_perc(lua_State* L)
    {
        CQuestManager & q = CQuestManager::instance();
        LPCHARACTER ch = q.GetCurrentCharacterPtr();
    ...
    static int pc_set_part(lua_State* L)
    {
        CQuestManager& q = CQuestManager::instance();
        LPCHARACTER ch = q.GetCurrentCharacterPtr();
        if (!lua_isnumber(L, 1) || !lua_isnumber(L, 2))
    ...
    static int pc_get_skillgroup(lua_State* L)
    {
        lua_pushnumber(L, CQuestManager::instance().GetCurrentCharacterPtr()->GetSkillGroup());
        return 1;
    }

    static int pc_set_skillgroup(lua_State* L)
    {
        if (!lua_isnumber(L, 1))
        {
    ...
    static int pc_is_polymorphed(lua_State* L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
    ...
    static int pc_remove_polymorph(lua_State* L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
    ...
    static int pc_polymorph(lua_State* L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
    ...
    static int pc_is_mount(lua_State* L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
    ...
    static int pc_mount(lua_State* L)
    {
        if (!lua_isnumber(L, 1))
        {
            return 0;
    ...
    static int pc_mount_bonus(lua_State* L)
    {
        ...
        if (LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr(); nullptr != ch)
        {
            ch->RemoveAffect(AFFECT_MOUNT_BONUS);
    ...
    static int pc_unmount(lua_State* L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
        ch->RemoveAffect(AFFECT_MOUNT);
        ch->RemoveAffect(AFFECT_MOUNT_BONUS);
    ...
    static int pc_get_horse_level(lua_State* L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
    ...
    static int pc_get_horse_hp(lua_State* L)
    {
        if (LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr(); ch->GetHorseLevel())
        {
    ...
    static int pc_get_horse_stamina(lua_State* L)
    {
        if (LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr(); ch->GetHorseLevel())
        {
    ...
    static int pc_is_horse_alive(lua_State* L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
    ...
    static int pc_revive_horse(lua_State* L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
        ch->ReviveHorse();
        return 0;
    ...
    static int pc_have_map_scroll(lua_State* L)
    {
        if (!lua_isstring(L, 1))
        {
            lua_pushboolean(L, 0);
    ...
    static int pc_get_war_map(lua_State* L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
    ...
    static int pc_have_pos_scroll(lua_State* L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
    ...
    static int pc_get_equip_refine_level(lua_State* L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
    ...
    static int pc_refine_equip(lua_State* L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
        if (!lua_isnumber(L, 1) || !lua_isnumber(L, 2))
        {
    ...
    static int pc_get_skill_level(lua_State * L)
    {
        if (!lua_isnumber(L, 1))
        {
            sys_err("invalid argument");
    ...
    static int pc_aggregate_monster(lua_State* L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
        ch->AggregateMonster();
        return 0;
    ...
    static int pc_forget_my_attacker(lua_State* L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
        ch->ForgetMyAttacker();
        return 0;
    ...
    static int pc_attract_ranger(lua_State* L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
        ch->AttractRanger();
        return 0;
    ...
    static int pc_select_pid(lua_State* L)
    {
    ...
    static int pc_select_vid(lua_State* L)
    {
    ...
    static int pc_get_sex(lua_State* L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
    ...
    static int pc_is_engaged(lua_State* L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
    ...
    static int pc_is_married(lua_State* L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
    ...
    static int pc_is_engaged_or_married(lua_State* L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
    ...
    static int pc_is_gm(lua_State* L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
    ...
    static int pc_get_gm_level(lua_State* L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
    ...
    static int pc_mining(lua_State* L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
    ...
    static int pc_diamond_refine(lua_State* L)
    {
        if (!lua_isnumber(L, 1))
        {
            lua_pushboolean(L, 0);
        ...
        if (LPITEM item = CQuestManager::instance().GetCurrentItem())
        {
    ...
    static int pc_ore_refine(lua_State* L)
    {
        if (!lua_isnumber(L, 1))
        {
            lua_pushboolean(L, 0);
        ...
        auto cost = (int) lua_tonumber(L, 1);
        auto pct = (int)lua_tonumber(L, 2);
        auto metinstone_cell = (int)lua_tonumber(L, 3);

        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
        LPCHARACTER npc = CQuestManager::instance().GetCurrentNPCCharacterPtr();
        LPITEM item = CQuestManager::instance().GetCurrentItem();

        if (LPITEM metinstone_item = ch->GetInventoryItem(metinstone_cell); item && metinstone_item)
        {
    ...
    static int pc_clear_skill(lua_State* L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
        if (ch == nullptr)
        {
    ...
    static int pc_clear_sub_skill(lua_State* L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
        if (ch == nullptr)
        {
    ...
    static int pc_set_skill_point(lua_State* L)
    {
        if (!lua_isnumber(L, 1))
        {
            return 0;
        ...
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
        auto newPoint = (int) lua_tonumber(L, 1);
    ...
    // RESET_ONE_SKILL
    static int pc_clear_one_skill(lua_State* L)
    {
        auto vnum = (int)lua_tonumber(L, 1);
    ...
    static int pc_is_clear_skill_group(lua_State* L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
    ...
    static int pc_save_exit_location(lua_State* L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
    ...
    //텔레포트
    static int pc_teleport(lua_State * L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
        int x = 0, y = 0;
        if (lua_isnumber(L, 1))
...
teleport_area:
    ...
    static int pc_set_skill_level(lua_State* L)
    {
        DWORD dwVnum = (DWORD)lua_tonumber(L, 1);
    ...
    static int pc_give_polymorph_book(lua_State* L)
    {
    ...
    static int pc_upgrade_polymorph_book(lua_State* L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
    ...
    static int pc_get_premium_remain_sec(lua_State* L)
    {
    ...
    static int pc_send_block_mode(lua_State* L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
    ...
    static int pc_change_empire(lua_State* L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
    ...
    static int pc_get_change_empire_count(lua_State* L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
    ...
    static int pc_set_change_empire_count(lua_State* L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
    ...
    static int pc_change_name(lua_State* L)
    {
        // 리턴값
        ...
        if (std::unique_ptr<SQLMsg> pmsg(DBManager::instance().DirectQuery(szQuery)); pmsg->Get()->uiNumRows > 0)
        {
    ...
    static int pc_is_dead(lua_State* L)
    {
        if (LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr(); ch != nullptr)
        {
    ...
    static int pc_reset_status(lua_State* L)
    {
        if (lua_isnumber(L, 1) == true)
        {
            auto idx = (int)lua_tonumber(L, 1);
    ...
    static int pc_get_ht(lua_State* L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
    ...
    static int pc_set_ht(lua_State* L)
    {
    ...
    static int pc_get_iq(lua_State* L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
    ...
    static int pc_set_iq(lua_State* L)
    {
        if (lua_isnumber(L, 1) == false)
        {
            return 1;
    ...
    static int pc_get_st(lua_State* L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
    ...
    static int pc_set_st(lua_State* L)
    {
        if (lua_isnumber(L, 1) == false)
        {
            return 1;
    ...
    static int pc_get_dx(lua_State* L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
    ...
    static int pc_set_dx(lua_State* L)
    {
        if (lua_isnumber(L, 1) == false)
        {
            return 1;
    ...
    static int pc_is_near_vid(lua_State* L)
    {
    ...
    static int pc_get_socket_items(lua_State* L)
    {
    ...
    static int pc_get_empty_inventory_count(lua_State* L)
    {
        if (LPCHARACTER pChar = CQuestManager::instance().GetCurrentCharacterPtr(); pChar != nullptr)
        {
    ...
    static int pc_get_logoff_interval(lua_State* L)
    {
        if (LPCHARACTER pChar = CQuestManager::instance().GetCurrentCharacterPtr(); pChar != nullptr)
        {
    ...
    static int pc_get_player_id(lua_State* L)
    {
        if (LPCHARACTER pChar = CQuestManager::instance().GetCurrentCharacterPtr(); pChar != nullptr)
        {
    ...
    static int pc_get_account_id(lua_State* L)
    {
        if (LPCHARACTER pChar = CQuestManager::instance().GetCurrentCharacterPtr(); pChar != nullptr)
        {
    ...
    static int pc_get_account(lua_State* L)
    {
        if (LPCHARACTER pChar = CQuestManager::instance().GetCurrentCharacterPtr(); nullptr != pChar)
        {
    ...
    static int pc_is_riding(lua_State* L)
    {
        if (LPCHARACTER pChar = CQuestManager::instance().GetCurrentCharacterPtr(); nullptr != pChar)
        {
    ...
    static int pc_get_special_ride_vnum(lua_State* L)
    {
        if (LPCHARACTER pChar = CQuestManager::instance().GetCurrentCharacterPtr(); nullptr != pChar)
        {
    ...
    static int pc_can_warp(lua_State* L)
    {
        if (LPCHARACTER pChar = CQuestManager::instance().GetCurrentCharacterPtr(); nullptr != pChar)
        {
    ...
    static int pc_dec_skill_point(lua_State* L)
    {
        if (LPCHARACTER pChar = CQuestManager::instance().GetCurrentCharacterPtr(); nullptr != pChar)
        {
    ...
    static int pc_get_skill_point(lua_State* L)
    {
        if (LPCHARACTER pChar = CQuestManager::instance().GetCurrentCharacterPtr(); nullptr != pChar)
        {
    ...
    static int pc_get_channel_id(lua_State* L)
    {
    ...
    static int pc_give_poly_marble(lua_State* L)
    {
    ...
    static int pc_get_sig_items(lua_State* L)
    {
    ...
    static int pc_charge_cash(lua_State * L)
    {
        ...
        {
            std::ranges::transform(strChargeType, strChargeType.begin(), (int (*)(int))std::tolower);
        }
    ...
    static int pc_give_award(lua_State* L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
        ...
        auto icount = (int) lua_tonumber(L, 2);
    ...
    static int pc_give_award_socket(lua_State* L)
    {
        LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
    ...
    static int pc_get_informer_type(lua_State* L)  //독일 선물 기능
    {
        if (LPCHARACTER pChar = CQuestManager::instance().GetCurrentCharacterPtr(); pChar != nullptr)
        {
    ...
    static int pc_get_informer_item(lua_State* L)
    {
        if (LPCHARACTER pChar = CQuestManager::instance().GetCurrentCharacterPtr(); pChar != nullptr)
        {
    ...
    static int pc_get_killee_drop_pct(lua_State* L)
    {
        LPCHARACTER pChar = CQuestManager::instance().GetCurrentCharacterPtr();
