...
int castle_siege (int empire, int tower_count)
{
    // check siege map
    {
        if (NULL == SECTREE_MANAGER::instance().GetMap (181))
        {
            return 0;
        }
        if (NULL == SECTREE_MANAGER::instance().GetMap (182))
        {
            return 0;
        }
        if (NULL == SECTREE_MANAGER::instance().GetMap (183))
        {
            return 0;
        }
    }
...
bool castle_is_my_castle (int empire, int map_index)
{
    ...
    {
        case EMPIRE_RED:
            return (181 == map_index);
        case EMPIRE_YELLOW:
            return (183 == map_index);
        case EMPIRE_BLUE:
            return (182 == map_index);
    }
    return false;
}
