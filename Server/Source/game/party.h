...
class CPartyManager : public singleton<CPartyManager>
{
    ...
    public:
        ...
        bool        IsEnablePCParty()
        {
            return m_bEnablePCParty;
        }
...
class CParty
{
    ...
    public:
        ...
        DWORD       GetLeaderPID() const;
        LPCHARACTER GetLeaderCharacter();
        LPCHARACTER GetLeader()
        {
            return m_pkChrLeader;
        }

        DWORD       GetMemberCount();
        DWORD       GetNearMemberCount()
        {
            return m_iCountNearPartyMember;
        }

        bool        IsMember(DWORD pid)
        {
            return m_memberMap.find(pid) != m_memberMap.end();
        }
        ...
        int     GetPartyBonusExpPercent()
        {
            return m_iExpBonus;
        }
        int     GetPartyBonusAttackGrade()
        {
            return m_iAttBonus;
        }
        int     GetPartyBonusDefenseGrade()
        {
            return m_iDefBonus;
        }
