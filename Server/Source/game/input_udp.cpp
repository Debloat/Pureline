...
using ServerStateChecker_Key = unsigned long;
using ServerStateChecker_Index = unsigned long;
using ServerStateChecker_State = unsigned char;
...
{
    auto * pInfo = (TPacketCGHandshake*) c_pData;
