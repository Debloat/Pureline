...
/* 저장하는 데이터 */
using CHARACTER_POINT = struct character_point
{
...
/* 저장되지 않는 캐릭터 데이터 */
using CHARACTER_POINT_INSTANT = struct character_point_instant
{
    long            points[POINT_MAX_NUM];
...
class CShop;
using LPSHOP = class CShop *;

class CMob;
class CMobInstance;
using TMobSkillInfo = struct SMobSkillInfo;
...
class CHARACTER : public CEntity, public CFSM, public CHorseRider
{
    ...
    public:
        ...
        bool            IsBlockMode(BYTE bFlag) const
        {
        ...
        {
            return m_bPolyMaintainStat;    // 이전 스텟을 유지하는 폴리모프.
        }
    ...
    public:
        ...
        using AttackLog = struct SAttackLog
        {
            DWORD   dwVID;
            DWORD   dwTime;
        };
    ...
    public:
        ...
        {
            return m_dwAffectedEunhyungLevel;
        }
    ...
    public:
        ...
        marriage::WeddingMap* GetWeddingMap() const
        {
    ...
    public:
        ...
        bool        DragonSoul_RefineWindow_CanRefine() const;
    ...
    public:
        ...
        void            SetSyncHackCount(int iCount)
        {
            m_iSyncHackCount = iCount;
        }
        int             GetSyncHackCount()
        {
            return m_iSyncHackCount;
        }
};
