...
CMobManager::CMobManager() = default;
...
bool CMobManager::LoadGroupGroup(const char* c_pszFileName)
{
    ...
    for (DWORD i = 0; i < loader.GetChildNodeCount(); ++i)
    {
        ...
        auto * pkGroup = M2_NEW CMobGroupGroup(iVnum);
