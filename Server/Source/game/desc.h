...
class DESC
{
    ...
    public:
        ...
        void            SetP2P (const char* h, WORD w, BYTE b)
        {
            m_stP2PHost = h;
            m_wP2PPort = w;
            m_bP2PChannel = b;
        }
        const char*     GetP2PHost()
        {
            return m_stP2PHost.c_str();
        }
        WORD            GetP2PPort() const
        {
            return m_wP2PPort;
        }
        BYTE            GetP2PChannel() const
        {
            return m_bP2PChannel;
        }
        ...
        CInputProcessor*        GetInputProcessor()
        {
        ...
        LPBUFFER        GetOutputBuffer()
        {
            return m_lpOutputBuffer;
        }

        void            BindAccountTable (TAccountTable * pTable);
        TAccountTable&      GetAccountTable()
        {
        ...
        {
            return m_iPhase == phase ? true : false;
        }
        ...
        const struct sockaddr_in& GetUDPAddr()
        {
            return m_UDPSockAddr;
        }
        ...
        DWORD           GetHandshake() const
        {
            return m_dwHandshake;
        }
        DWORD           GetClientTime();
        ...
        const DWORD*    GetEncryptionKey() const
        {
            return &m_adwEncryptionKey[0];
        }
        const DWORD*    GetDecryptionKey() const
        {
            return &m_adwDecryptionKey[0];
        }
        #endif
        ...
        void            SetMatrixCode (const char* c_psz)
        {
            m_stMatrixCode = c_psz;
        }
        const char*         GetMatrixCode()
        {
            return m_stMatrixCode.c_str();
        }
        ...
        void            SetPanamaKey (DWORD dwKey)
        {
            m_dwPanamaKey = dwKey;
        }
        DWORD           GetPanamaKey() const
        {
            return m_dwPanamaKey;
        }
        ...
        void            SetClientVersion (const char* c_pszTimestamp)
        {
            m_stClientVersion = c_pszTimestamp;
        }
        const char*         GetClientVersion()
        {
            return m_stClientVersion.c_str();
        }

        bool            isChannelStatusRequested() const
        {
            return m_bChannelStatusRequested;
        }
        void            SetChannelStatusRequested (bool bChannelStatusRequested)
        {
            m_bChannelStatusRequested = bChannelStatusRequested;
        }
    ...
    public:
        void SetMatrixCardID (const char* szCardID)
        {
            m_stMatrixCardID = szCardID;
        }
        const char* GetMatrixCardID()
        {
            return m_stMatrixCardID.c_str();
        }
        void SetMatrixQuiz (const char* szCode)
        {
            m_stMatrixCode = szCode;
        }
        const char* GetMatrixQuiz()
        {
            return m_stMatrixCode.c_str();
        }
