...
class CPetSystem
{
    ...
    public:
        ...
        CPetActor*  Summon (DWORD mobVnum, LPITEM pSummonItem, const char* petName, bool bSpawnFar,
        ...
        CPetActor*  AddPet (DWORD mobVnum, const char* petName, const SPetAbility& ability,
                            DWORD options = CPetActor::EPetOption_Followable | CPetActor::EPetOption_Summonable | CPetActor::EPetOption_Combatable);
