...
CAsyncSQL::CAsyncSQL()
    : m_stHost(""), m_stUser(""), m_stPassword(""), m_stDB(""), m_stLocale(""),
      m_iMsgCount(0), m_iPort(0),
      #ifndef __WIN32__
      m_hThread(0),
      #else
      m_bEnd(false),
      #endif
      m_hThread(INVALID_HANDLE_VALUE), m_mtxQuery(nullptr),
      m_mtxResult(nullptr), m_iQueryFinished(0), m_ulThreadID(0), m_bConnected(false),
      m_iCopiedQuery(0)
{
